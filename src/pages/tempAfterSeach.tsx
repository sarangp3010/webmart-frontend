const AfterSeach = () => {
    return (
        <div>
            <div className="collapse d-lg-block sidebar collapse bg-white">

                <header>
                    <nav id="sidebarMenu" className="collapse d-lg-block sidebar collapse bg-white" style={{maxWidth: "40px"}}>
                    ...
                    <nav id="main-navbar" className="navbar navbar-expand-lg navbar-light bg-white fixed-top">
                        <div className="container-fluid">
                            ...
                            <form className="d-none d-md-flex input-group w-auto my-auto">
                                <input autoComplete="on" type="search" className="form-control rounded"
